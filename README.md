...
<sub>The renderer is authored as strict TypeScript, compiled to a generated `.mjs` artefact by GitHub Actions, and fed by the GitHub GraphQL API. No external profile-stat service is involved.</sub>
